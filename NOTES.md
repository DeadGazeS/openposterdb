...
0. **Badge layout / size / layout-grid round (2026-08-02)**:
   ...
   - Verified: `go build/vet/test` all pass; vitest 309/309 pass; `vue-tsc --noEmit` clean. Render checks: poster top 2×1 + bottom 3×1 renders both rows at the correct edges; logo default bottom 5×1 renders 5 columns below the logo.
