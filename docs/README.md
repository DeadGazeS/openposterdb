...
- **[Building from Source](development.md)** — running without Docker for local development
- **[Architecture](architecture.md)** — cache layers, key formats, and internals (for contributors)
